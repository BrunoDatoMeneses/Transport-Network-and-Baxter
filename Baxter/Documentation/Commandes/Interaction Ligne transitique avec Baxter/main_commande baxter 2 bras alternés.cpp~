...
//////////////////////////////////////////////
	...
	M[41] = 1; // 1 seule prise à la fois

	M[42] = 1; // Disponibilité bras droit baxter
	M[43] = 1; // Disponibilité bras gauche baxter
...
//////////////////////////////////////////////
	...
	while (ros::ok())
	{
		...
		if(M[19] >= 1 && M[34] >=1) {if (0){M[19]--;M[20]++;M[34]--;} else if(1) { M[19]-- ;M[21]++;M[34]--;}} // t16 et t17
		...
		if(M[27]>=1 && M[42]>=1 && M[41]>=1){ if(!PSx[22]) {M[41]--;M[42]--;M[27]--;M[35]++;}}	//t30

		if(M[27]>=1 && M[43]>=1 && M[41]>=1){ if(!PSx[22]) {M[41]--;M[43]--;M[27]--;M[36]++;}}	//t31

		if(M[35]>=1 ){ if(PSx[22]) {M[35]--;M[37]++;Baxter.Prise_demandee_bras_gauche();}}	//t32

		if(M[36]>=1 ){ if(PSx[22]) {M[36]--;M[38]++;Baxter.Prise_demandee_bras_droit();}}	//t33

		if(M[37]>=1){ if(Baxter.Prise_effectuee_bras_gauche() && !PSx[24]) {M[37]--;M[40]++;M[43]++;}}	//t34

		if(M[38]>=1){ if(Baxter.Prise_effectuee_bras_droit() && !PSx[24]) {M[38]--;M[40]++;M[42]++;}}	//t35


		//////////


		if( M[40]>=1  && M[33] >=1){ if(PSx[24]) {M[40]--;M[33]--;M[29]++;M[41]++;}}	//t25
