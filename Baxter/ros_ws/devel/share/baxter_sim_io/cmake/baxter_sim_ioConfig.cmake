...
if("TRUE" STREQUAL "TRUE")
  set(baxter_sim_io_SOURCE_PREFIX /home/etudiant/M1_ISTR/Baxter/ros_ws/src/baxter_simulator/baxter_sim_io)
  set(baxter_sim_io_DEVEL_PREFIX /home/etudiant/M1_ISTR/Baxter/ros_ws/devel)
  ...
  set(baxter_sim_io_INSTALL_PREFIX /home/etudiant/M1_ISTR/Baxter/ros_ws/install)
...
if(NOT "/home/etudiant/M1_ISTR/Baxter/ros_ws/src/baxter_simulator/baxter_sim_io/include " STREQUAL " ")
  set(baxter_sim_io_INCLUDE_DIRS "")
  set(_include_dirs "/home/etudiant/M1_ISTR/Baxter/ros_ws/src/baxter_simulator/baxter_sim_io/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'baxter_sim_io' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Rethink Robotics Inc. <rsdk.support@rethinkrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'baxter_sim_io' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/etudiant/M1_ISTR/Baxter/ros_ws/src/baxter_simulator/baxter_sim_io/${idir}'.  Ask the maintainer 'Rethink Robotics Inc. <rsdk.support@rethinkrobotics.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${baxter_sim_io_dep}_FOUND)
      find_package(${baxter_sim_io_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${baxter_sim_io_dep} REQUIRED ${depend_list})
  endif()
