...
"""autogenerated by genpy from baxter_core_msgs/AnalogIOState.msg. Do not edit."""
import sys
...
class AnalogIOState(genpy.Message):
  _md5sum = "39af371963dc9e4447e91f430c720b33"
  _type = "baxter_core_msgs/AnalogIOState"
...
"""
  __slots__ = ['timestamp','value','isInputOnly']
  _slot_types = ['time','float64','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AnalogIOState, self).__init__(*args, **kwds)
