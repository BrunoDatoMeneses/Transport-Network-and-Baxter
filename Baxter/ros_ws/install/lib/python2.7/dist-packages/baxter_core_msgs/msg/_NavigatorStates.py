  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.states:
        ...
        buff.write(_struct_B.pack(val1.wheel))
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sB'%length
        buff.write(struct.pack(pattern, *val1.lights))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.buttons = struct.unpack(pattern, str[start:end])
        val1.buttons = map(bool, val1.buttons)
        start = end
        end += 1
        (val1.wheel,) = _struct_B.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.light_names = []
        ...
        val1.lights = struct.unpack(pattern, str[start:end])
        val1.lights = map(bool, val1.lights)
