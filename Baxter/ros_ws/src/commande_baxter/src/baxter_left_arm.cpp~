...
Baxter_left_arm::Baxter_left_arm(ros::NodeHandle noeud) 
{
	...
	client_prise_effectuee = noeud.serviceClient<commande_baxter::bool_state>("/pont_BaxterLigneTransitique/service/left_arm/prise_effectuee",true);
	client_attente_prise = noeud.serviceClient<commande_baxter::bool_state>("/pont_BaxterLigneTransitique/service/left_arm/attente_prise",true);	


	//Server
	srv_prise_demandee = noeud.advertiseService("/pont_BaxterLigneTransitique/service/left_arm/prise_demandee",&Baxter_left_arm::Srv_prise_demmandee,this);
...
// Services
bool Baxter_left_arm::Srv_prise_demmandee(commande_baxter::bool_state::Request  &req,
         commande_baxter::bool_state::Response &res)
{
	msg_prise_demandee.data = req.query ;
  	res.state =  1;
  	return true;
}
