...
private:
	...
	//Client
	ros::ServiceClient client_inverse_kinematics, client_prise_demandee ;

	//Server
	ros::ServiceServer srv_prise_effectuee, srv_attente_prise ;
...
public:
	...
	// Services
	bool Srv_prise_effectuee(commande_baxter::bool_state::Request  &req,
         commande_baxter::bool_state::Response &res);
	bool Srv_attente_prise(commande_baxter::bool_state::Request  &req,
         commande_baxter::bool_state::Response &res);
