...
CVisionVelodyneVPL16::CVisionVelodyneVPL16(const int visionSensorHandles[4],float frequency,int options,float pointSize,float coloringDistances[2],float scalingFactor)
{
	for (int i=0;i<4;i++)
