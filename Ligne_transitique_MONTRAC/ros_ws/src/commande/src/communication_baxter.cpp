...
Communication_Baxter::Communication_Baxter(ros::NodeHandle noeud)
{
	...
	//Client
	client_prise_effectuee_bras_gauche = noeud.serviceClient<commande_baxter::bool_state>("/pont_BaxterLigneTransitique/service/left_arm/prise_effectuee");
	client_attente_prise_bras_gauche = noeud.serviceClient<commande_baxter::bool_state>("/pont_BaxterLigneTransitique/service/left_arm/attente_prise");
