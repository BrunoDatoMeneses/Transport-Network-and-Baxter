...
Communication_Baxter::Communication_Baxter(ros::NodeHandle noeud)
{
	...
	//Client
	client_prise_demandee_bras_gauche = noeud.serviceClient<commande_baxter::bool_state>("/pont_BaxterLigneTransitique/service/left_arm/prise_demandee",true);

	//Server
	srv_prise_effectuee_bras_gauche = noeud.advertiseService("/pont_BaxterLigneTransitique/service/left_arm/prise_effectuee", &Communication_Baxter::Srv_prise_effectuee_bras_gauche,this);
	srv_attente_prise_bras_gauche = noeud.advertiseService("/pont_BaxterLigneTransitique/service/left_arm/attente_prise", &Communication_Baxter::Srv_attente_prise_bras_gauche,this);
...
//Service
bool Communication_Baxter::Srv_attente_prise_bras_gauche(commande_baxter::bool_state::Request  &req,
         commande_baxter::bool_state::Response &res)
{
	msg_attente_prise_bras_gauche.data = req.query ;
  	res.state = 1;
  	return true;
}

bool Communication_Baxter::Srv_prise_effectuee_bras_gauche(commande_baxter::bool_state::Request  &req,
         commande_baxter::bool_state::Response &res)
{
	msg_prise_effectuee_bras_gauche.data = req.query ;
  	res.state = 1;
  	return true;
}
...
{
	commande_baxter::bool_state srv_prise_demandee_bras_gauche;

	srv_prise_demandee_bras_gauche.request.query = msg_prise_demandee_bras_gauche.data;
	if (client_prise_demandee_bras_gauche.call(srv_prise_demandee_bras_gauche)) {}
  	else{ROS_ERROR("Failed to call prise_demandee_bras_gauche");}
