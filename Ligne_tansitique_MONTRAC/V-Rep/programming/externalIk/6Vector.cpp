...
C6Vector::C6Vector(extIkReal v0,extIkReal v1,extIkReal v2,extIkReal v3,extIkReal v4,extIkReal v5)
{
	V[0](0)=v0;
	V[0](1)=v1;
	V[0](2)=v2;
...
C6Vector::C6Vector(const extIkReal v[6])
{
	V[0](0)=v[0];
	V[0](1)=v[1];
	V[0](2)=v[2];
...
C6Vector C6Vector::operator* (extIkReal d) const
{
	C6Vector retV;
	retV.V[0]=V[0]*d;
	retV.V[1]=V[1]*d;
...
extIkReal C6Vector::operator* (const C6Vector& v) const
...
void C6Vector::operator*= (extIkReal d)
{
	V[0]*=d;
	V[1]*=d;
}
