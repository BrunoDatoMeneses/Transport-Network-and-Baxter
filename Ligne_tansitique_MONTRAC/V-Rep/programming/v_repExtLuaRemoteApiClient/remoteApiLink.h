...
public:
	...
	void handleCommand(int cmdId,CLuaFunctionData* inOutData,bool blocking,bool threaded);
...
protected:
	...
	void _handleCommand(int cmdId,CLuaFunctionData* inOutData);
	...
	std::vector<CLuaFunctionData*> _commandsToHandle; // NULL represents free locations
