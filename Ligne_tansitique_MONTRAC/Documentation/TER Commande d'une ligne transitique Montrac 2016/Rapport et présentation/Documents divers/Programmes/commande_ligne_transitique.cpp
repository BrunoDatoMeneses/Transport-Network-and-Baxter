...
// Recuperation des valeurs des capteurs si reception du message Capteurs
void Commande_ligne::Callback_capteurs(const commande_ligne_transitique::Capteurs msg)
{
	CAPTEURS=msg.capteurs;
}

// Publication des actionneurs pour les API
...
//// Actualiser Capteurs pour le main ////
...
//// Actualiser Actionneurs avant la publication ////
