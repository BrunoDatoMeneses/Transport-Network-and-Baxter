...
(cl:in-package commande_ligne_transitique-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Actionneurs>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Actionneurs)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name commande_ligne_transitique-msg:<Actionneurs> is deprecated: use commande_ligne_transitique-msg:Actionneurs instead.")))

(cl:ensure-generic-function 'actionneurs-val :lambda-list '(m))
(cl:defmethod actionneurs-val ((m <Actionneurs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader commande_ligne_transitique-msg:actionneurs-val is deprecated.  Use commande_ligne_transitique-msg:actionneurs instead.")
  (actionneurs m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Actionneurs>)))
  ...
  "commande_ligne_transitique/Actionneurs")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Actionneurs)))
  "Returns string type for a message object of type 'Actionneurs"
  "commande_ligne_transitique/Actionneurs")
