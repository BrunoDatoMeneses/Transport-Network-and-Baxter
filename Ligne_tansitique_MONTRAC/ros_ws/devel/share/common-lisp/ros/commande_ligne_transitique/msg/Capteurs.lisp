...
(cl:defmethod cl:initialize-instance :after ((m <Capteurs>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Capteurs)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name commande_ligne_transitique-msg:<Capteurs> is deprecated: use commande_ligne_transitique-msg:Capteurs instead.")))

(cl:ensure-generic-function 'capteurs-val :lambda-list '(m))
(cl:defmethod capteurs-val ((m <Capteurs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader commande_ligne_transitique-msg:capteurs-val is deprecated.  Use commande_ligne_transitique-msg:capteurs instead.")
  (capteurs m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Capteurs>)))
  ...
  "commande_ligne_transitique/Capteurs")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Capteurs)))
  "Returns string type for a message object of type 'Capteurs"
  "commande_ligne_transitique/Capteurs")
